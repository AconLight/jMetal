...
public class MemeticNSGAII<S extends Solution<?>> extends AbstractGeneticAlgorithm<S, List<S>> {
   ...
   * Constructor
   */
  public MemeticNSGAII(Problem<S> problem, int maxEvaluations, int populationSize,
